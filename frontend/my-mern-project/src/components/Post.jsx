...
const Post = ({ data }) => {
  ...
  return (
    <div className="w-[26%] bg-[#f6ecea] rounded-lg px-2 py-2 flex flex-col justify-center">
      <p className="tracking-tighter font-semibold mb-2 text-base">
        Created by @ {data.author?.username}
      </p>
      <h2 className="w-full mb-4 text-2xl text-center font-bold uppercase">
        {data.title}
      </h2>
      <p className="w-full mb-4 text-md leading-6 capitalize px-2">
        {data.content}
      </p>
